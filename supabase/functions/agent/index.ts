...
各選択肢のrationale（career/life/income/psychology）は、必ず以下のフォーマットで書いてください。

理想：「〔idealsから引用〕」／現状：「〔improvements/reasonsから引用〕」→〔この選択肢によって具体的にどう改善されるか・何をすればよいか〕

- 「／」と「→」は必ず使うこと（表示上の改行に使用する）
  ...
  "options": [
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（200字程度）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 転職でこのギャップを埋める理由（200字程度）",
        "life": "理想：〔引用〕／現状〔点〕→ 副業＋転職でライフ面が改善する理由（200字程度）",
        "income": "理想：〔引用〕／現状〔点〕→ 転職後の収入＋副業月〇〇万円で実現する理由（200字程度）",
        "psychology": "理想：〔引用〕→ この選択肢がなぜ心理的に最適か（200字程度）"
      },
    ...
    },
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（200字程度）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 現職のままでどこまでギャップが埋まるか（200字程度）",
        "life": "理想：〔引用〕／現状〔点〕→ 副業でライフ面が改善する理由（200字程度）",
        "income": "理想：〔引用〕／現状〔点〕→ 副業月〇〇万円で収入がどう変わるか（200字程度）",
        "psychology": "理想：〔引用〕→ 現職継続が心理的に与える影響（200字程度）"
      },
      "nextAction": "今すぐできる具体的な一歩（50字以内）",
      "risk": "この選択肢の主なリスク（50字以内）"
    },
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（200字程度）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 転職だけで解決できるギャップとできないギャップ（200字程度）",
        "life": "理想：〔引用〕／現状〔点〕→ 転職のみのライフへの影響（200字程度）",
        "income": "理想：〔引用〕／現状〔点〕→ 転職のみでの収入変化の試算（200字程度）",
        "psychology": "理想：〔引用〕→ 転職のみが心理的に与える影響（200字程度）"
      },
      "nextAction": "今すぐできる具体的な一歩（50字以内）",
      "risk": "この選択肢の主なリスク（50字以内）"
    },
    {
      ...
      "summary": "ユーザーの理想と現状ギャップを踏まえた概要（200字程度）",
      "rationale": {
        "career": "理想：〔引用〕／現状〔点〕→ 現状維持でどのリスクがあるか（200字程度）",
        "life": "理想：〔引用〕／現状〔点〕→ 現状維持がライフ面に与える影響（200字程度）",
        "income": "理想：〔引用〕／現状〔点〕→ 現状維持での収入見通し（200字程度）",
        "psychology": "理想：〔引用〕→ 現状維持が心理的に与える影響（200字程度）"
      },
      "nextAction": "今すぐできる具体的な一歩（50字以内）",
      "risk": "この選択肢の主なリスク（50字以内）"
    }
